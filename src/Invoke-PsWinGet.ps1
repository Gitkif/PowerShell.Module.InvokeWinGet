...
New-Alias -Name 'pswinget' -Value Invoke-PSWinGet -Force -ErrorAction Ignore -Description "Call WinGet and Parse Output. Module PowerShell.Invoke.WinGetCommand" -Scope Global
Export-ModuleMember -Function Invoke-PSWinGet
